...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%"
        TypeName="ASCISTARCustom.Cost.ASCIStarAPTariffHTSCodeEntry"
...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
	<px:PXGrid KeepPosition="True" runat="server" Height="150px" SkinID="Details" Width="100%" ID="grid" AllowAutoHide="false" DataSourceID="ds" SyncPosition="True">
