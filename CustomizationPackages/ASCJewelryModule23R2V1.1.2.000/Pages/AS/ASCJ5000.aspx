...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" DataMember="Filter" Width="100%" Height="60px" AllowAutoHide="false">
        <Template>
            ...
            <px:PXSelector CommitChanges="True" AllowEdit="True" runat="server" ID="ASCJInventoryIDSegmentMask5" DataField="InventoryID"></px:PXSelector>
        </Template>
    </px:PXFormView>
</asp:Content>
    ...
    <px:PXGrid AllowPaging="True" KeepPosition="True" SyncPosition="True" ID="grid" runat="server" DataSourceID="ds" Width="100%" Height="150px" SkinID="Inquire" AllowAutoHide="false">
        <Levels>
            <px:PXGridLevel DataMember="VandorBasis">
                <Columns>
                    <px:PXGridColumn CommitChanges="True" Type="CheckBox" TextAlign="Center" AllowCheckAll="True" DataField="Selected" Width="60"></px:PXGridColumn>
                    ...
                    <px:PXGridColumn DataField="Commodity" Width="70"></px:PXGridColumn>
                </Columns>

                <RowTemplate>
                    <px:PXSegmentMask AllowEdit="True" runat="server" ID="CstPXSegmentMask7" DataField="InventoryID"></px:PXSegmentMask>
                    <px:PXSegmentMask AllowEdit="True" runat="server" ID="CstPXSegmentMask8" DataField="VendorID"></px:PXSegmentMask>
                </RowTemplate>
            </px:PXGridLevel>
        </Levels>
