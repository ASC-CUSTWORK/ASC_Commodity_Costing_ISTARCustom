...
namespace ASCJSMCustom.AP.CacheExt
{
    public sealed class ASCJSMAPVendorPriceExt : PXCacheExtension<APVendorPrice>
    {
        ...
        [CommodityType.List]
        [PXDefault(typeof(Search<ASCJSMINInventoryItemExt.usrCommodityType, Where<InventoryItem.inventoryID, Equal<Current<APVendorPrice.inventoryID>>>>), PersistingCheck = PXPersistingCheck.Nothing)]
        ...
        [PXFormula(typeof(Switch<
            Case<Where<APVendorPrice.uOM.IsNotEqual<ASCJSMConstants.TOZ>.Or<APVendorPrice.salesPrice.IsNotNull.And<APVendorPrice.salesPrice.IsEqual<PX.Objects.CS.decimal0>>>>, Null>,
                        Mult<Div<usrCommodityPerGram, APVendorPrice.salesPrice>, Add<ASCJSMConstants.DecimalOne, Div<usrCommoditySurchargePct, ASCJSMConstants.DecimalOneHundred>>>>))]
