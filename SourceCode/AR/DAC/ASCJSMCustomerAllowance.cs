...
using static ASCJSMCustom.AR.Descriptor.ASCJSMARConstants;

namespace ASCJSMCustom.AR.DAC
{
    [Serializable]
    [PXCacheName("Customer Allowance")]
    public partial class ASCJSMCustomerAllowance : AuditSystemFields, IBqlTable
    {
        #region Keys
        public class PK : PrimaryKeyOf<ASCJSMCustomerAllowance>.By<customerID, orderType, inventoryID, commodity>
        {
            public static ASCJSMCustomerAllowance Find(PXGraph graph, int customerID, string orderType, int inventoryID, string commodity) => FindBy(graph, customerID, orderType, inventoryID, commodity);
        }
        public static class FK
        {
            public class Customer : PX.Objects.AR.Customer.PK.ForeignKeyOf<ASCJSMCustomerAllowance>.By<customerID> { }
            public class InventoryItem : PX.Objects.IN.InventoryItem.PK.ForeignKeyOf<ASCJSMCustomerAllowance>.By<inventoryID> { }
