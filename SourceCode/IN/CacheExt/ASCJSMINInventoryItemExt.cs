...
namespace ASCJSMCustom.IN.CacheExt
{
    public class ASCJSMINInventoryItemExt : PXCacheExtension<InventoryItem>, IASCJSMItemCostSpecDTO
    {
        ...
        [ASCJSMINConstants.InventoryItemStatusExt.List]
        ...
        [PXSelector(typeof(Search2<InventoryItem.inventoryID, LeftJoin<INItemClass, On<InventoryItem.itemClassID, Equal<INItemClass.itemClassID>>>,
            Where<INItemClass.itemClassCD, Equal<ASCJSMConstants.CommodityClass>>>),
        ...
        //#region UsrAddOnValue
        //[PXDecimal(4)]
        //[PXUIField(DisplayName = "Price / TOZ Add-On", IsReadOnly = true)]
        //[PXDefault(TypeCode.Decimal, "0.000000", PersistingCheck = PXPersistingCheck.Nothing)]
        //public decimal? UsrAddOnValue { get; set; }
        //public abstract class usrAddOnValue : PX.Data.BQL.BqlDecimal.Field<usrAddOnValue> { }
        //#endregion
        ...
        [PXDBDecimal(6)]
        [PXUIField(DisplayName = "Vendor/Dollar", IsReadOnly = true)]
