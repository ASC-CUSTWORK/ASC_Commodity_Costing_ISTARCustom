...
namespace ASCJSMCustom.Cost.DAC
{
    [Serializable]
    [PXCacheName(_cacheName)]
    [PXPrimaryGraph(typeof(ASCJSMSetupMaint))]
    public class ASCJSMSetup : AuditSystemFields, IBqlTable
    {
        ...
        #region Symbols
        [PXDBString(256, IsUnicode = true)]
        [ASCJSNSymbols.List(MultiSelect = true)]
        [PXDefault()]
