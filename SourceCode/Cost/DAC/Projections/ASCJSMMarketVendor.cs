...
namespace ASCJSMCustom.Cost.DAC.Projections
{
    [Serializable]
    ...
    public class ASCJSMMarketVendor : IBqlTable
    {
        ...
        [PXUIField(DisplayName = "Item Class ID", Enabled = false, Visibility = PXUIVisibility.SelectorVisible)]
        ...
        #region Market
        [PXDBString(2, IsUnicode = true, InputMask = "", BqlField = typeof(ASCJSMAPVendorPriceExt.usrMarket))]
        ...
        #region MarketID
        [PXDBInt(BqlField = typeof(ASCJSMAPVendorPriceExt.usrMarketID))]
        ...
        #region Commodity
        [PXDBString(1, BqlField = typeof(ASCJSMAPVendorPriceExt.usrCommodity))]
