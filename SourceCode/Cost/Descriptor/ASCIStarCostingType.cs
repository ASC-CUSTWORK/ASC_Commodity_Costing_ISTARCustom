...
namespace ASCISTARCustom.Cost.Descriptor
{
    public class ASCIStarCostingType
    {
        ...
        {
            private static readonly string[] values = new string[] { StandardCost, MarketCost, ContractCost, PercentageCost, WeightCost };
            private static readonly string[] lables = new string[] { MessageStandard, MessageMarket, MessageContract, MessagePercentage, MessageWeight };
