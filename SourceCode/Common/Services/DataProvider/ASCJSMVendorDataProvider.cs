...
{
    public class ASCJSMVendorDataProvider : IASCJSMrVendorDataProvider
    {
        private readonly PXGraph _graph;

        public ASCJSMVendorDataProvider(PXGraph graph)
        {
            _graph = graph;
        }
        ...
        public Vendor GetVendor(int? bAccountID, bool withException = false)
        {
            ...
            if (result == null)
            {
                throw new PXException(ASCJSMMessages.Error.VendorRecordNotFound);
            }
