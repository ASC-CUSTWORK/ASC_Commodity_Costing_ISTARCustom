...
namespace ASCJSMCustom.Common.Services.REST.Interfaces
{
    public interface IASCJSMRESTService
    {
        /// <summary>
        ...
        TModel Get<TModel>(string endpoint, params KeyValuePair<string, string>[] parameters) where TModel : IASCJSMModel;

        ASCJSMSetup GetASCIStarSetup();
    }
}
