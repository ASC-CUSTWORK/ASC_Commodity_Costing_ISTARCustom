...
namespace ASCJSMCustom.Common.Helper.Extensions
{
    public static class ASCJSMStringExtension
    {
        /// <summary>
        ...
        public static string ToErrorString<TModel>(this string value) where TModel : ASCJSMErrorModel
        {
            var errorModel = ASCJSMJsonConverter<TModel>.FromJson(value);
