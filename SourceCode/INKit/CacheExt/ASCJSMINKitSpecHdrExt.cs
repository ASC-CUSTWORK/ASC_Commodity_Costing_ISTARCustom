...
{
    public sealed class ASCJSMINKitSpecHdrExt : PXCacheExtension<INKitSpecHdr>, IASCJSMItemCostSpecDTO
    {
        ...
        [PXFormula(typeof(Selector<INKitSpecHdr.kitInventoryID, ASCJSMINInventoryItemExt.usrMatrixStep>))]
